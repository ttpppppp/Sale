...
let suggestSearch = document.querySelector(".suggestSerach");
let writting = document.querySelector(".writing");
...
cart.forEach(cartItem => {
    cartItem.addEventListener('click' , function(){
        noti.classList.add('animtionNoti');
        setTimeout(function() {
            noti.classList.remove('animtionNoti');
        }, 2000);
    });
});
